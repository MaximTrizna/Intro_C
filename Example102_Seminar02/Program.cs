...
// Методы ввода информации и проверки на истину/ложь :
...
/* Found: Console.Write("Введите цифру, обозначающую день недели: ");
int n = Convert.ToInt32(Console.ReadLine());

if (n>0 && n<6) 
{
    Console.Write ($"Извините, но {n}-й день недели не выходной");
}
else if (n==6 || n==7)
{
    Console.Write ($"Поздравляем, {n}-й день недели выходной");
}
else if (n<1 || n>7)
{
